...
$ConfigManagerErrorCode = @{
    ...
    26 = "Windows is still setting up this device. (2)"
...
if ($DevicesWithIssue.count -gt 0) {
    Foreach ($Device in $DevicesWithIssue) {
        Write-Verbose "Device: $($Device.FriendlyName) Class: $($Device.PNPClass) PNPDeviceID: $($Device.PNPDeviceID) ConfigManagerErrorCode: $($Device.ConfigManagerErrorCode) ErrorDescription: $($ConfigManagerErrorCode[[int]$Device.ConfigManagerErrorCode])"
        $Output += " | Device: $($Device.FriendlyName) Class: $($Device.PNPClass) PNPDeviceID: $($Device.PNPDeviceID) Err: $($Device.ConfigManagerErrorCode)"
    }
